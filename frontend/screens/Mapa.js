...
const Mapa = () => {
  ...
  const { paxCoordinates, driverCoordinates, getPaxCoordinates, getDriverCoordinates } = useContext(AuthContext);
  ...
  const handleMapPress = e => {
    ...
    getPaxCoordinates(location.coords.latitude, location.coords.longitude);
    getDriverCoordinates(latitude, longitude);
  ...
  useEffect(() => {
    ...
    const fetchData = () => {
      axios.get('http://192.168.18.7:3000')
        .then((res) => {
